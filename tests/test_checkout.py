...
def test_checkout_first_name_required(authenticated_page: Page):
    ...
    cart.checkout()
    expect(authenticated_page.get_by_text("Checkout: Your Information")).to_be_visible()
    checkout.fill_information("", "last_check", "81450")
    checkout.continue_checkout()
    expect(authenticated_page.get_by_text("Error: First Name is required")).to_be_visible()
...
def test_checkout_last_name_required(authenticated_page: Page):
    ...
    cart.checkout()
    expect(authenticated_page.get_by_text("Checkout: Your Information")).to_be_visible()
    checkout.fill_information("standard_user", "", "81450")
    checkout.continue_checkout()
    expect(authenticated_page.get_by_text("Error: Last Name is required")).to_be_visible()
...
def test_checkout_postal_code_required(authenticated_page: Page):
    ...
    cart.checkout()
    expect(authenticated_page.get_by_text("Checkout: Your Information")).to_be_visible()
    checkout.fill_information("standard_user", "last_check", "")
    checkout.continue_checkout()
    expect(authenticated_page.get_by_text("Error: Postal Code is required")).to_be_visible()
...
def test_checkout_cancel(authenticated_page: Page):
    ...
    cart.checkout()
    expect(authenticated_page.get_by_text("Checkout: Your Information")).to_be_visible()
    checkout.fill_information("standard_user", "last_check", "81456")
    checkout.continue_checkout()
    expect(authenticated_page.get_by_text("Checkout: Overview")).to_be_visible()
    checkout.cancel()
